...
exports.Aurora = {
    ...
    噩廻: {
        info: (0, Modify_1.genBuffInfo)("状态:噩廻"),
        canSatck: true,
        stackMultModify: {
            攻击: 0.002,
        },
    ...
    /**荆雷奔袭攻击力效果 */
    荆雷奔袭A: {
        info: (0, Modify_1.genBuffInfo)("状态:荆雷奔袭A"),
        multModify: {
            雷电伤害: 0.25,
        },
        damageCons: ["雷电技能"]
    ...
    /**电棘丛生被动效果 */
    电棘丛生: {
        info: (0, Modify_1.genBuffInfo)("状态:电棘丛生"),
        tiggerList: [{
                hook: "造成技能伤害前",
                tigger(damage) {
                    ...
                    if (char.buffTable.getBuffStack(exports.Aurora.电棘丛生B) < 3)
                        char.addBuff(exports.Aurora.电棘丛生A);
                    if (char.buffTable.getBuffStack(exports.Aurora.电棘丛生A) >= 3) {
                        char.buffTable.addBuff(exports.Aurora.电棘丛生A, -3);
                        char.buffTable.addBuff(exports.Aurora.电棘丛生B, 1);
                    }
                    return damage;
                }
            }]
    ...
    /**电棘丛生攻击计数器 */
    电棘丛生A: {
        info: (0, Modify_1.genBuffInfo)("状态:电棘丛生A"),
        canSatck: true,
    },
    /**电棘丛生攻击力效果 */
    电棘丛生B: {
        info: (0, Modify_1.genBuffInfo)("状态:电棘丛生B"),
        canSatck: true,
        stackLimit: 3,
        stackMultModify: {
            攻击: 0.05,
    ...
    /**续存战意被动效果 */
    续存战意: {
        info: (0, Modify_1.genBuffInfo)("状态:续存战意"),
        tiggerList: [{
                hook: "释放技能后",
                tigger(skillData) {
    ...
    /**续存战意 每层效果 */
    续存战意A: {
        info: (0, Modify_1.genBuffInfo)("状态:续存战意A"),
        canSatck: true,
        stackLimit: 5,
        stackMultModify: {
            攻击: 0.015,
    ...
    /**续存战意 5层效果 */
    续存战意B: {
        info: (0, Modify_1.genBuffInfo)("状态:续存战意B"),
        multModify: {
            攻击: 0.075,
        }
    },
